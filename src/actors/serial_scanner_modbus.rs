            ...
            SerialScannerMsg::Tick => {
                ...
                for p in ports {
                    ...
                    if !state.known.contains_key(&key) {
                        info!(
                            ...
                            "SerialScanner: USB attached -> opening"
                        );
                        ...
                        match builder.open_native_async() {
                            ...
                            Err(e) => {
                                error!(port = %full_path, error = %e, "SerialScanner: failed to open serial stream");
                            }
                        }
                    }
                }
                ...
                for key in existing {
                    if !seen.contains(&key) {
                        ...
                        info!(port = %key, "SerialScanner: USB detached -> notify fabric");
                    }
                }
